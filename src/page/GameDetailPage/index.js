...
import './detail.css';
import { IconStar } from '../../data/images/index';
import { Row, Col, Spinner } from 'react-bootstrap';

import Tappable from 'react-tappable';


const GameDetailPage = ({history}) => {
             ...
             <div className="result-floating" style={{justifyContent: 'space-between'}}>
               <div className="styled-btn"
                ...
                style={{backgroundColor: colors.green, marginRight: 8}}>
                  ...
                  <div className="VPink f24">Play Again</div>
                  </Tappable>
                </div>
                <div className="styled-btn" 
