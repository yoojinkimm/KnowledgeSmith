...
import { LandingPage, GameCardPage, ResultPage, LoginPage, MyPage, LeaderBoardPage, TutorialPage, GameDetailPage } from './page';
      ...
      <div className="App">
        ...
        <Router basename={process.env.PUBLIC_URL}>
          <Switch>
            ...
            <Route exact path='/mygame' component={GameDetailPage} />
          </Switch>
        </Router>
        </div>
      </div>
